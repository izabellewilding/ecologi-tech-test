...
function App() {
  const [treeData, setData] = useState<{data: TreeData[]}>();
  ...
  const groupedByDay: {[key: string ]: TreeData[]}  = groupBy(orderedByDay, (item: TreeData) => {
    return item.createdAt.split("T")[0];
  });


  const groupedByDayExample = {
    '15-10-1993': [{ value: 19829,}],
    '15-11-1993': [{ value: 19829,}]
  }
